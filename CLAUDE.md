...
Otoya is a high-precision web audio player built for multi-device synchronized playback. It's a monorepo using Turborepo with:
...
1. **Create R2 Bucket:**
   ...
   - Create a new bucket named `otoya-audio` (or customize in env vars)
